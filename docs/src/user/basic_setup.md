...
```console
$ wget https://github.com/containers/youki/releases/download/vv0.4.0/youki_v0_4_0_linux.tar.gz
$ tar -zxvf youki_v0_4_0_linux.tar.gz youki_v0_4_0_linux/youki-v0.4.0/youki
# Maybe you need root privileges.
$ mv youki_v0_4_0_linux/youki-v0.4.0/youki /usr/local/bin/youki
$ rm -rf youki_v0_4_0_linux.tar.gz youki_v0_4_0_linux
```
