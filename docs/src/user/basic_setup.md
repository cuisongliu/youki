...
<!--youki release begin-->
```console
$ wget -qO youki_0.3.0_linux.tar.gz https://github.com/containers/youki/releases/download/v0.3.0/youki_0_3_0_linux-$(uname -m).tar.gz
$ tar -zxvf youki_0.3.0_linux.tar.gz --strip-components=1
# Maybe you need root privileges.
$ mv youki-0.3.0/youki /usr/local/bin/youki
$ rm -rf youki_0.3.0_linux.tar.gz youki-0.3.0
```
<!--youki release end-->
