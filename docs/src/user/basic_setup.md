...
<!--youki release begin-->
```console
$ wget -qO youki_0.2.3_linux.tar.gz https://github.com/containers/youki/releases/download/v0.2.3/youki_0_2_3_linux-$(uname -m).tar.gz
$ tar -zxvf youki_0.2.3_linux.tar.gz --strip-components=1
# Maybe you need root privileges.
$ mv youki-0.2.3/youki /usr/local/bin/youki
$ rm -rf youki_0.2.3_linux.tar.gz youki-0.2.3
```
<!--youki release end-->
