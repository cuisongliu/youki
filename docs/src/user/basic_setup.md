...
```console
$ wget -qO youki_0.0.23_linux.tar.gz https://github.com/containers/youki/releases/download/v0.0.23/youki_0.0.23_linux-$(uname -m).tar.gz
$ tar -zxvf youki_0.0.23_linux.tar.gz --strip-components=1
# Maybe you need root privileges.
$ mv youki-0.0.23/youki /usr/local/bin/youki
$ rm -rf youki_0.0.23_linux.tar.gz youki-0.0.23
```
