...
```console
$ wget https://github.com/containers/youki/releases/download/v0.3.1/youki_0_3_1_linux.tar.gz
$ tar -zxvf youki_0_3_1_linux.tar.gz youki_0_3_1_linux/youki-0.3.1/youki
# Maybe you need root privileges.
$ mv youki_0_3_1_linux/youki-0.3.1/youki /usr/local/bin/youki
$ rm -rf youki_0_3_1_linux.tar.gz youki_0_3_1_linux
```
